...
const AppsCard = ({ app }) => {
  ...
  return (
    <Link to={`/app/${id}`} className="card shadow-sm  hover:scale-105 transition ease-in-out">
      ...
      <div className="card-body">
        ...
        <div className='flex justify-between items-center'>
          <button className="btn bg-gray-200 border-none btn-sm text-[#00D390]">
            <img className='w-4' src='/icon-downloads.png' alt="" />
            {downloads}</button>
          <button className="btn btn-sm bg-gray-200 border-none text-[#FF8811]">
